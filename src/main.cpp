...
int main(int argc, char** args)
{
    ...
    IYieldValue* fibonacci = new Fibonacci;                                     // @TODO Create Fibonacci class which will implement interface -> IYieldValue
    IYieldValue* goldenNumber = new GoldenNumber;                                  // @TODO Create GoldenNumber class which will implement interface -> IYieldValue
    IRocketLauncher* icbmLauncher = new RocketLauncher;         // @TODO Create IcbmLauncher class which will implement interface -> IRocketLauncher
    ICalculator* newWorldCalculator = new WeirdCalculator;                           // @TODO Create NewWorldCalculator class which will implement interface -> ICalculator
